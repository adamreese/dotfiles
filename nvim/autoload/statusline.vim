...
function! statusline#lightlineFilename()
  return s:filename('%') . s:modified() . s:readonly()
endfunction

function! statusline#lightlineFugitive()
  if s:is_readonly_filetype()
    return ''
  endif
...
function! statusline#lightlineFileformat()
...
function! statusline#lightlineFiletype()
  if winwidth(0) < 70 || s:is_no_fileformat_filetype()
    return ''
  endif
...
function! statusline#lightlineFileencoding()
  if winwidth(0) < 70 || s:is_no_fileformat_filetype()
    return ''
  endif
...
function! statusline#lightlineMode()
...
function! statusline#StatusLineLineInfo()
...
function! statusline#lightlineLineInfo()
  return '%{statusline#StatusLineLineInfo()}'
endfunction

function! statusline#lightlineGo()
  return exists('*go#jobcontrol#Statusline') ? go#jobcontrol#Statusline() : ''
endfunction

function! statusline#lightlineNeomake()
